  ...
  return (
    <div className="max-w-[760px] mx-auto px-8">
      <section className="pb-6 border-b border-line mb-8">
        ...
        <h1 className="title-display text-[44px]">Conta</h1>
      </section>

      <section className="mb-12 pb-8 border-b border-line-soft">
        <h2 className="font-serif italic text-[24px] font-medium mb-4">Identidade</h2>
        <p className="label-tech text-ink-mute mb-1">Email</p>
        <p className="font-mono text-[15px]">{user.email || '—'}</p>
      </section>

      <section className="mb-12 pb-8 border-b border-line-soft">
        <h2 className="font-serif italic text-[24px] font-medium mb-4">Credencial Discogs</h2>
        {user.discogsCredentialStatus === 'invalid' ? (
          <p
            role="alert"
            className="bg-accent/10 border border-accent text-ink px-4 py-2 mb-4 font-serif text-[15px]"
          >
      ...
      <section>
        <h2 className="font-serif italic text-[24px] font-medium mb-4 text-warn">
          Zona perigosa
        </h2>
        <p className="font-serif italic text-[16px] text-ink-soft leading-relaxed mb-5 max-w-[560px]">
