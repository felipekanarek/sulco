    ...
    <div className="max-w-[1240px] mx-auto px-8">
      ...
      {rows.length === 0 ? (
        <div className="border border-dashed border-line p-10 text-center">
          ...
          <p className="font-serif italic text-xl text-ink-soft mb-6">
            Comece criando seu primeiro set — uma coletânea ordenada de faixas pra um evento.
          </p>
          <Link
            href="/sets/novo"
            className="inline-block font-mono text-[11px] uppercase tracking-[0.12em] bg-ink text-paper px-5 py-3 rounded-sm hover:bg-accent transition-colors"
          >
            + Novo set
          </Link>
        </div>
